<?php
    ...
    } else if ( $interest_rate > 15 || $interest_rate <= 0) {
        $error_message = 'Interest rate must be between 1% and 15%.'; 
    // validate year entry
    } else if ( $years > 50 || $years <= 0) {
        $error_message = 'The years must be between 1 and 50.'; 
...
//    }
	...
	// calculate the power of the investment
